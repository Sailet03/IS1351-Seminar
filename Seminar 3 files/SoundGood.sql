...
ALTER TABLE Siblings ADD CONSTRAINT PK_Siblings PRIMARY KEY (studentId,siblingStudentId);
...
ALTER TABLE Siblings ADD CONSTRAINT FK_Siblings_1 FOREIGN KEY (siblingStudentId) REFERENCES Student (studentId);
