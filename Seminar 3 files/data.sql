INSERT INTO Student (studentId,personalNumber,name,street,city,zip,phoneNumber,emailAdress)
VALUES
  (1,'200508138474','Reed Sanchez','391-3649 Arcu Rd.','Marabá','37725-47191','(213) 861-6973','euismod@hotmail.ca'),
  (2,'199705011756','Jolene Cain','335-7658 Lacinia. Rd.','Wunstorf','6598','(720) 263-2026','ipsum.cursus@outlook.ca'),
  (3,'200712248540','Jasper Herrera','900-7739 Arcu. St.','Caucaia','596853','1-469-998-1187','iaculis.enim.sit@google.couk'),
  (4,'201611130674','Isabelle Williamson','326-6102 Ut Road','Liberia','25759','(857) 471-5168','a.neque.nullam@icloud.couk'),
  (5,'198801221395','Sheila Battle','P.O. Box 860, 4263 Nulla Road','Awka','4778','1-999-854-8244','a@icloud.couk'),  
  (6,'201506158356','Brady Ramos','8635 Erat Street','Ludvika','33175','(572) 393-0312','amet@protonmail.couk'),
  (7,'201408057295','Devin Sweet','P.O. Box 210, 5549 Elit Road','Norrköping','36115','1-392-682-2028','cursus@icloud.ca'),
  (8,'200911010516','Hiroko Sykes','2635 Nec, Rd.','Norrköping','64441','(486) 286-6482','dolor.fusce@google.couk');
...
INSERT INTO Teacher (teacherId,personalNumber,name,street,city,zip,phoneNumber,emailAdress)
VALUES  
  (1,'198501150647','Myles Gamble','Ap #157-5045 Et St.','Bischofshofen','42528','1-418-687-4755','laoreet.lectus@google.org'),
  (2,'197704210683','Cheryl Farmer','Ap #189-8715 Habitant Street','Camiña','61312','1-899-205-2246','integer.urna@hotmail.com'),
  (3,'199912147593','Zelda Booth','1694 Enim Avenue','Marabá','24813','(825) 828-7027','risus.a@yahoo.net'),
  (4,'200011061956','Shellie Graves','P.O. Box 770, 2614 Nibh. Rd.','Caen','71893','1-506-872-9188','in.sodales.elit@aol.couk'),
  (5,'198905071753','Beatrice Reese','P.O. Box 511, 5069 Sapien, St.','Vereeniging','57156','(317) 587-8305','id.enim@google.ca');
